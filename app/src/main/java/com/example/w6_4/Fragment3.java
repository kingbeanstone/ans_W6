...
//        return inflater.inflate(R.layout.fragment3,container,false);
    ...
    public void onMapReady(@NonNull NaverMap naverMap) {
        ...
        // 대구 좌표
        latlng[1] = new LatLng(35.88974, 128.6105);
        // 부산 좌표
        latlng[2] = new LatLng(35.184912, 129.076744);

        // 지도 중심: 경북대학교
//        com.naver.maps.geometry.LatLng latlng_center = new com.naver.maps.geometry.LatLng(35.88974, 128.6105);
        com.naver.maps.geometry.LatLng latlng_center = new com.naver.maps.geometry.LatLng((latlng[0].latitude + latlng[2].latitude)/2, (latlng[0].longitude + latlng[2].longitude)/2);
...
// 지도 크기
                ...
                while (eventType != XmlPullParser.END_DOCUMENT) {
                    ...
                    if (eventType == XmlPullParser.START_DOCUMENT) {
                        ...
                        if (itemCode.equals("PM10") &&
                                (tag_name.equals("seoul") || tag_name.equals("daegu")|| tag_name.equals("busan")))
                            bSet_city = true;
    ...
    public void addInfo(LatLng latlng, String city, String pollution_degree) {
        ...
        infoWindow1.setAdapter(new InfoWindow.DefaultTextAdapter(getContext()) {
            @NonNull
            @Override
